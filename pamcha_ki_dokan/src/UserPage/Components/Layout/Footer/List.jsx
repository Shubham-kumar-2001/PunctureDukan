...
const List = (props) => {
  ...
  return (
    <li>
      ...
      >
        <span className="flex-shrink-0 w-5 h-5 text-gray-500 transition rounded duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-black">
