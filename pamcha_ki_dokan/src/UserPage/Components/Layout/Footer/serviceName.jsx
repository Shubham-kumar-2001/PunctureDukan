...
const ServiceName = (props) => {
  return (
    <li>
      <Link
        to="puncturedukan/services"
        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-black hover:bg-gray-100 dark:hover:bg-gray-200 group"
      >
        <span className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 rounded-xl dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-black">
